...
| `@mapatlas/react` | `core`, `maplibre`, `recorder-web`, `react` | `<MapCanvas>`, `<EventComposer>`, `<TripReview>`, `useTrackRecorder`, `useTrackList`, `useTrackDraft`, `useEventLog`, `useOfflineRegions` |
