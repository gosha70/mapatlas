...
- **T4.1 MapController + layers.** Mount MapLibre GL, ordered `TileSource[]`, attribution. _AC:_
  base + overlay composite; attribution rendered verbatim.
- **T4.2 Track & events render.** Live position, growing track line, event `Marker`s,
