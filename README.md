...
[`specs/tasks.md`](specs/tasks.md) carries a **Done** record for 13 of its 52 tasks; the first in document order is T4.6.
...
| 7 — Demo + docs | 4 | 4 |
| 8 — Follow-ups (post-v1, recorded and unscheduled) | 3 | 0 |
